...
function minMax(arr){
  ...
  // RETURNS
  // Return both the lowest and highest value numbers in an array
  // EXAMPLES
  // [1,2,3,4,5] --> [1,5]
  // PSEUDO
  // Create an empty array and assign it to a variable
  // Sort the original array in ascending order
  // Use .shift() and .pop() on the original array and transfer the values to the empty array
  // Return the empty array
  // However, if the original array contains only 1 character, concatenate it with itself and return the result